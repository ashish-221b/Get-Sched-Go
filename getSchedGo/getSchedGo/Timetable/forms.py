...
class EventForm(forms.ModelForm):
        ...
        StartTime = forms.DateTimeField(required=False,widget=forms.DateTimeInput)
        ...
        Type = forms.CharField(required=False,choices = Event_Type,widget = forms.RadioSelect)
